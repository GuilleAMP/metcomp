...
;; Esta función ahora solo pasa los tokens directamente
(define (parse-html token-list)
  (raw-parser (lambda () (if (null? token-list) 'EOF (begin0 (car token-list) (set! token-list (cdr token-list)))))))
